    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(help_text='Phone Number', max_length=13, unique=True, validators=[core.validators.phone_validator], verbose_name='Phone Number')),
            ...
            managers=[
                ('objects', core.models.MyUserBaseManager()),
            ],
        ),
    ]
